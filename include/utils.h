...
void fifty_deg_turn(QAngle angle = 50_deg);
void ninety_deg_turn(QAngle new_angle = 90_deg);
void one_hundred_twenty_deg_turn_heavy(QAngle new_angle = 120_deg);
void ninety_deg_turn_heavy_inaccurate(QAngle new_angle = 90_deg);
